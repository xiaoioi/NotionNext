...
const BLOG = {
  AUTHOR: '乔晓啸', // 作者
  BIO: '一个鸽子', // 作者简介
  LINK: 'https://blog.xiao811.eu.org', // 网站地址
  ...
  CONTACT_EMAIL: 'ygxdxrk_0526@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/xiaoioi',
  CONTACT_TELEGRAM: 'https://t.me/xiaoioi',
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://waline.xiao811.eu.org', // Waline 评论 @see https://waline.js.org/guide/get-started.html
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '晓啸小窝', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
